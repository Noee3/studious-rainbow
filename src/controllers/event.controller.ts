...
export class EventController {
    public eventRepository: EventRespository;

    constructor(eventRepository: EventRespository) {
        this.eventRepository = eventRepository;
    }

    public async fetchContractEvents(contractAddress: Address, abi: any, blockToAdd: bigint, eventName?: string, args?: {}): Promise<Event[]> {
        try {
